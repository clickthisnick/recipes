...
class SweetPotato1Days extends Recipe {
    constructor() {
        ...
        this.steps = [
            e.oven().preheat(425),
            Timer.end(),
            e.pan().add([i.sweetPotatoes(300, u.gram), i.oliveOil(1, u.tbsp)]),
            e.pan().cook(30, 'm', 425),
            Timer.end(),
    ...
    constructor() {
        ...
        this.steps = [
            ...
            e
                ...
                .add([
                    i.ingredient(
                        'frozen cauliflower/shitake mushroom',
                        1,
                        u.smallstainlesssteelcontainer
                    ),
            ...
            e.pan(1).add([i.sweetPotatoes(300, u.gram), i.oliveOil(1, u.tbsp)]),
