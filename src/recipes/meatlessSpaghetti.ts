...
class WalnutMeatlessSpaghetti extends Recipe {
    constructor() {
        super();
        this.steps = [
            e.pan().add([i.oliveOil(1, u.tbsp)]),
            e.pan().cook(1, 'm', PAN_TEMPERATURE),
            Timer.end(),
            e.pan().add([i.whiteOnion(1, u.unit)]),
            e.pan().cook(5, 'm', PAN_TEMPERATURE),
            Timer.end(),
            e.pan().add([i.garlicClove(3, u.clove)]),
            e.pan().cook(1, 'm', PAN_TEMPERATURE),
            Timer.end(),
            e.pot().add([i.lentilSpaghetti(), i.water(16, u.ounce)]),
            e.pot().cookWithLid(12, 'm', 9),
            e.pan().add([i.shitatkeMushroom(8, u.ounce)]),
            e.pan().cook(9, 'm', PAN_TEMPERATURE),
            Timer.end(),
            e.pan().add([i.walnut(0.33, u.cup)]),
            ...
            e
                ...
                .add([
                    ...
                    i.sweetPaprika(0.5, u.tsp),
                    i.redPepperFlakes(0.5, u.tsp),
                    i.garlicPowder(0.5, u.tsp),
                    i.onionPowder(0.5, u.tsp),
                    i.driedOregano(0.5, u.tsp),
                    i.driedThyme(0.25, u.tsp),
                    i.blackPepper(0.25, u.tsp),
                    i.kosherSalt(0.5, u.tsp),
                ]),
...
class WalnutMeatlessSpaghettiNoMushrooms extends Recipe {
    constructor() {
        ...
        this.steps = [
            ...
            e.pan().cook(30, 's', PAN_TEMPERATURE),
            Timer.end(),
            e.pan().add([i.nutritionalYeast(1, u.tbsp), i.spaghettiSauce(1, u.unit)]),
            Timer.end(),
            e.pan().cook(8, 'm', PAN_TEMPERATURE),
            Timer.end(),
            e.pan().add([i.lentilSpaghetti()]),
