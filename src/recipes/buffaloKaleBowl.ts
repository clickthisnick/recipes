...
export class MealRecipe extends RecipeContainer {
    constructor() {
        super();
        this.variations = [BuffaloKaleBowlWhiteRice, BuffaloKaleBowlBrownRice];
    }
}
...
class BuffaloKaleBowlBrownRice extends Recipe {
    constructor() {
        super();
        this.steps = [
            e.instantPot().add([i.brownRice(1, u.cup), i.water(1.5, u.cup)]),
            ...
            text.set([
                ...
                "in sink with strainer (So bean juice doesn't get on counter)",
            ]),
            Timer.end(),
            e.pan().add([i.chilliOil(2, u.tbsp), i.kale()]),
            ...
            i.whiteRice().mixIn([i.curryPowder(0.5, u.tbsp)]),
            text.set([
                'In a bowl mix',
                i.blackBeans(),
                i.brownRice(),
...
class BuffaloKaleBowlWhiteRice extends Recipe {
    constructor() {
        super();
        this.steps = [
            e.instantPot().add([i.whiteRice(1, u.cup), i.water(1.5, u.cup)]),
