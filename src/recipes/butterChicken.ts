...
export class MealRecipe extends RecipeContainer {
    constructor() {
        super();
        this.variations = [ThreeQuartButterChicken, SixQuartButterChicken];
    }
}
...
class ThreeQuartButterChicken extends Recipe {
    constructor() {
        ...
        this.steps = [
            ...
            text.set(['Dice', i.whiteOnion(0.5, u.unit)]),
            text.set(['Dice', i.garlicClove(2.5, u.unit)]),
            e
                .instantPot()
                .add([
                    i.oliveOil(0.5, u.tbsp),
                    i.butter(0.5, u.tbsp),
                    i.whiteOnion(),
            ...
            Timer.end(),
            e.instantPot().add([i.tomatoPaste(3, u.ounce)]),
            Timer.set(1.5, 'm', 'Constantly stir'),
            Timer.end(),
            e.instantPot().add([
                i.water(0.25, u.cup),
                i.Groups.chicken(),
                i.gramMasala(0.5, u.tbsp),
                i.paprika(0.5, u.tsp),
                i.coconutSugar(1, u.tsp),
                i.cumin(0.5, u.tsp),
                i.turmeric(0.25, u.tsp),
                i.salt(0.5, u.tsp), // .5 for healthier
            ...
            text.set(['Stir in', i.coconutCream(0.5, u.cup)]),
...
class SixQuartButterChicken extends Recipe {
    constructor() {
        ...
        this.steps = [
            ...
            text.set(['Wash cutting boards']),
            Timer.end(),
            e.instantPot().add([i.tomatoPaste(6, u.ounce)]),
            ...
            Timer.end(),
            text.set(['Take inner instant pot bowl out and put on stove. Put away instant pot.']),
            text.set(['Stir in', i.coconutCream(0.75, u.cup)]),
