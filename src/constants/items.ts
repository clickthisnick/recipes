...
export class Items {
    ...
    public static readonly bonelessRibClubSteak: IItem = (quantity: number = 1, unit: IItemObj) => ({
    ...
    public static readonly chickenThighPackage: IItem = (quantity: number = 1, unit: IItemObj) => ({
