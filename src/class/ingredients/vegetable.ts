...
export class VegetableItems extends SpiceItems {
    ...
    public static readonly instaPot: IItem = (quantity: number = 0, unit: IUnitObj) => ({
        name: 'InstaPot',
        putAwayTime: 10,
        takeOutTime: 10,
        cleanSteps: '',
    ...
    public static readonly asparagus: IItem = (quantity: number = 0, unit: IUnitObj) => ({
        name: 'Asparagus',
        putAwayTime: 10,
        takeOutTime: 10,
        cleanSteps: '',
    ...
    public static readonly crimniMushroom: IItem = (quantity: number = 0, unit: IUnitObj) => ({
