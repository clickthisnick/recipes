...
export class VegetableItems extends SpiceItems {
    ...
    public static readonly liquidSmoke: IItem = (quantity: number = .00001, unit: IUnitObj) => ({
        name: 'Liquid Smoke',
        putAwayTime: 10,
        takeOutTime: 10,
        cleanSteps: '',
    ...
    public static readonly seasonedRiceVinegar: IItem = (quantity: number = .00001, unit: IUnitObj) => ({
    ...
    public static readonly appleCiderVinegar: IItem = (quantity: number = .00001, unit: IUnitObj) => ({
    ...
    public static readonly babyBella: IItem = (quantity: number = .00001, unit: IUnitObj) => ({
        name: 'Baby Bella',
        putAwayTime: 10,
        takeOutTime: 10,
        cleanSteps: '',
