import { IUnitObj, Units } from '../../constants/units';
...
export class Ingredient {
    ...
    public cutInHalf(): IStep {
        return this.createStep(['Cut', this.formatName(), 'in half'], {
            equipment: this.knifeTools(),
        });
    }

    public peel(): IStep {
        return this.createStep(['Peel', this.formatName()], { equipment: [e.peeler()] });
    }

    public juice(): IStep {
        return this.createStep(['Juice', this.formatName()], { equipment: [e.knife()] });
    }

    public chop(): IStep {
        return this.createStep(['Chop', this.formatName()], { equipment: this.knifeTools() });
    }

    public cube(): IStep {
        return this.createStep(['Cube', this.formatName()], { equipment: this.knifeTools() });
    }

    public rinse(): IStep {
        return this.createStep(['Rinse', this.formatName()], { equipment: this.knifeTools() });
    }

    public dice(): IStep {
        return this.createStep(['Dice', this.formatName()], { equipment: this.knifeTools() });
    }

    public mince(): IStep {
        return this.createStep(['Mince', this.formatName()], { equipment: this.knifeTools() });
    }

    public cutIntoStrips(): IStep {
        return this.createStep(['Cut', this.formatName(), 'into strips'], {
            equipment: this.knifeTools(),
        });
    }

    public cutIntoOneInchPieces(): IStep {
        return this.createStep(['Cut', this.formatName(), 'into one inch pieces'], {
            equipment: this.knifeTools(),
        });
    }

    public cutIntoHalfInchStrips(): IStep {
        return this.createStep(['Cut', this.formatName(), 'into half inch strips'], {
            equipment: this.knifeTools(),
        });
    }

    public cutIntoThinSlices(): IStep {
        return this.createStep(['Slice', this.formatName(), 'thinly'], {
            equipment: this.knifeTools(),
        });
    }

    public cutIntoSlices(): IStep {
        return this.createStep(['Cut', this.formatName(), 'into slices'], {
            equipment: this.knifeTools(),
        });
    }

    public patDry(): IStep {
        return this.createStep(['Pat', this.formatName(), 'dry with paper towels']);
    }
}
