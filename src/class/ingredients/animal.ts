...
export class AnimalItems {
    ...
    public static readonly salmon: IItem = (quantity: number = 1, unit: IUnitObj) => ({
        name: 'Salmon',
        putAwayTime: 10,
        takeOutTime: 10,
        cleanSteps: '',
    ...
    public static readonly sirloinTop: IItem = (quantity: number = 1, unit: IUnitObj) => ({
        name: 'Sirloin Top',
        putAwayTime: 10,
        takeOutTime: 10,
        cleanSteps: '',
    ...
    public static readonly cheddarCheese: IItem = (quantity: number = 1, unit: IUnitObj) => ({
        name: 'Cheedar Cheese',
        putAwayTime: 10,
        takeOutTime: 10,
    ...
    public static readonly eggPasta: IItem = (quantity: number = 1, unit: IUnitObj) => ({
        name: 'Egg Pasta',
        putAwayTime: 10,
        takeOutTime: 10,
