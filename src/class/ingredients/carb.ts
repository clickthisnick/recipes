...
export class CarbItems extends AnimalItems {
    ...
    public static readonly raoPastaElbow: IItem = (quantity: number = 1, unit: IUnitObj) => ({
    ...
    public static readonly lentilSpaghetti: IItem = (quantity: number = 1, unit: IUnitObj) => ({
