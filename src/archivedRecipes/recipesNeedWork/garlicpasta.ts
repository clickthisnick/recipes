...
export class MealRecipe extends Recipe {
    constructor() {
        ...
        this.addIngredients([
            ...
            i.Groups.mushroom(3),
            i.garlicClove(2),
            i.parmesanCheese(0.25, u.cup),
            i.vegetableOil(2, u.second),
            i.spiriliazer(),
            i.blackPepper(),
            i.butter(2, u.tbsp),
            i.pepperFlake(0.25, u.tsp),
            i.salt(0.25, u.tsp),
        ]);
    }
    ...
    public generateRecipe() {
        ...
        this.addSteps([
            ...
            ['Put zuchinni in pan'],
            [Timer.set(5, 'm')],
            ['Put in', this.get(i.pepperFlake(0.25))],
            [Timer.set(2, 'm')],
            ['Top with', this.get(i.butter())],
            ['Top with', this.get(i.parmesanCheese(0.25))],
            ['Season with', this.get(i.blackPepper()), 'and', this.get(i.salt(0.25))],
        ]);
        this.printRecipe();
    }
}
