...
class Sushi extends Recipe {
    ...
    public generateRecipe() {
        ...
        this.addSteps([
            ...
            [Timer.set(2, 'm', 'Let rice air dry')],
            ...
            ['Put', i.appleCiderVinegar(), 'in glass bowl'],
            ['Put', i.seasonedRiceVinegar(), 'in glass bowl'],
            ['Put', i.salt(), 'in glass bowl'],
            ['Put', i.sugar(), 'in glass bowl'],
            [Timer.set(1, 'm', 'Micowave for one minute then stir')],
            ['Combine vinegar bowl with', i.sushiRice(0)],
            [Timer.set(30, 'm', 'Cover mixture in tinfoil with poked holes and set in fridge')],
