...
export class MealRecipe extends RecipeContainer {
    constructor() {
        super();
        this.variations = [MiniCinnamonRolls, CinnamonRolls];
    }
}
...
export class CinnamonRolls extends Recipe {
    constructor() {
        super();
        this.steps = [
            e.bowl().add([i.water(1, u.cup), i.appleSauce(4, u.tbsp)]),
            ...
            e
                ...
                .add([i.ingredient('yeast mixture'), i.wholeWheatFlour(3, u.cup)]),
            ...
            e
                .bowl()
                .add([i.coconutOil(3, u.tbsp), i.coconutSugar(0.25, u.cup), i.cinnamon(1, u.tbsp)]),
...
export class MiniCinnamonRolls extends Recipe {
    constructor() {
        ...
        this.steps = [
            ...
            text.set([
                'Flatten dough into a rectangle as thin as possible on baking tray (No parchment paper)',
            ]),
            text.set(['Spread filling mixture on dough']),
            text.set(['Roll up dough']),
            text.set(['Cut into individual rolls and place on baking sheet']),
