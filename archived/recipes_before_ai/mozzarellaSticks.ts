...
export class MealRecipe extends RecipeContainer {
    constructor() {
        super();
        this.variations = [MozzarellaSticks];
    }
}
    ...
    constructor() {
        ...
        this.steps = [
            ...
            e
                .bowl()
                .add([
                    i.pankoBreadCrumbs(0.5, u.cup),
                    i.onionGranules(0.5, u.tsp),
            ...
            Timer.end(),
            e.ninja().add([i.ingredient('cheese sticks')]),
